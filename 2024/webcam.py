...
# Load the models
model_korban = YOLO("/home/rafi/Vision/model/korban_best_RGB.pt")
model_tembok = YOLO("/home/rafi/Visiom/model/wall_best_DEPTH.pt")
model_sz = YOLO("/home/rafi/Vision/model/savezone.pt")

# Initialize serial communication
teensy = serial.Serial('/dev/ttyUSB0', 115200, timeout=0)
#teensy = serial.Serial('/dev/ttyTHS1', 115200, timeout=0)
...
try:
    while True:
        # Check request data from Teensy
        try:
